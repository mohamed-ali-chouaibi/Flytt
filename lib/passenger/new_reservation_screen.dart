...
class NewReservationScreen extends StatefulWidget {
  ...
  const NewReservationScreen({Key? key, this.initialLocation}) : super(key: key);
  @override
        ...
        child: Column(
          ...
          children: [
            AppBar(
              ...
              title: Text(
                AppLocalizations.of(context).translate('reserve_your_ride'),
                style: TextStyle(
                  ...
                  child: Padding(
                    ...
                    child: GestureDetector(
                          ...
                          builder: (context, child) => Theme(
                            data: Theme.of(context).copyWith(
                              colorScheme: ColorScheme.dark(
                                primary: RydyColors.textColor,
                                onPrimary: RydyColors.darkBg,
                                surface: RydyColors.cardBg,
                                onSurface: Colors.white,
                                secondary: RydyColors.textColor,
                                onSecondary: RydyColors.textColor,
                              ),
                              dialogBackgroundColor: RydyColors.darkBg,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: RydyColors.cardBg.withOpacity(0.98),
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(color: RydyColors.subText.withOpacity(0.13), width: 1.2),
                          boxShadow: [
                            BoxShadow(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(Icons.calendar_today_rounded, color: RydyColors.subText, size: 22),
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            Icon(Icons.access_time_rounded, color: RydyColors.textColor, size: 22),
                            const SizedBox(width: 10),
                            Text(
                              _selectedTime != null
